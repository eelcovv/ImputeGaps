...
IMPUTATION_METHODS = {"median": ["float", "percentage", "dict", "bool", "int"]}
ID_KEY = "be_id"
SET_SEED = 2
...
def test_float():
    """
    Test voor var_type 'float' met imputatiemethode 'median'
    """
...
def test_percentage():
    """
    Test voor var_type 'percentage' met imputatiemethode 'median'
    """
    records_df = pd.DataFrame(
        [
            [1, 1, "A", "10", 1.2],
