...
IMPUTATION_METHODS = {"nan": ["float", "percentage", "dict", "bool", "int"]}
ID_KEY = "be_id"
SET_SEED = 2
...
def test_float():
    """
    Test voor var_type 'float' met imputatiemethode 'nan'
    """
    ...
    # Expected
    expected = pd.Series([1.1, 2.2, 3.3, 4.4, 0, 0, 0], copy=False, name="telewerkers")
...
def test_percentage():
    """
    Test voor var_type 'percentage' met imputatiemethode 'nan'
    """
    records_df = pd.DataFrame(
        [
            [1, 1, "A", "10", 1.1],
...
def test_bool():
    ...
    # Expected
    expected = pd.Series([float(1), 0, 1, 0, 0, 0, 0], copy=False, name="telewerkers")
...
def test_dict():
    ...
    # Expected
    expected = pd.Series([float(1), 2, 3, 4, 0, 0, 0], copy=False, name="telewerkers")
...
def test_met_filter():
    """
    Test voor var_type 'dict' met imputatiemethode 'nan'
    """
    records_df = pd.DataFrame(
        [
            [1, 1, "A", "10", 1],
    ...
    # Expected
    expected = pd.Series([1, 2, 3, 4, None, 0, 0], copy=False, name="telewerkers")
