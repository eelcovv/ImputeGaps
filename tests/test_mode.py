...
IMPUTATION_METHODS = {"mode": ["float", "percentage", "dict", "bool", "int"]}
ID_KEY = "be_id"
SET_SEED = 2
...
def test_float():
    """
    Test voor var_type 'float' met imputatiemethode 'mode'
    """
    ...
    # Expected
    expected = pd.Series([1.1, 2.2, 3.3, 4.4, 1.1, 1.1, 1.1], copy=False, name="telewerkers")
...
def test_percentage():
    """
    Test voor var_type 'percentage' met imputatiemethode 'mode'
    """
    records_df = pd.DataFrame(
        [
            [1, 1, "A", "10", 1.1],
...
def test_bool():
    """
    Test voor var_type 'bool' met imputatiemethode 'mode'
    """
    records_df = pd.DataFrame(
        [
            [1, 1, "A", "10", 1],
...
def test_met_filter():
    """
    Test voor var_type 'dict' met imputatiemethode 'mode'
    """
    records_df = pd.DataFrame(
        [
            [1, 1, "A", "10", 1],
